...
def main(args):
    ...
    # Output TSVs
    pval_df.to_csv('noncoding_complete_results.tsv', sep='\t', index=False)
    narrow_results.to_csv('noncoding_narrow_results.tsv', sep='\t', index=False)
    wide_results.to_csv('noncoding_wide_results.tsv', sep='\t'), index=False

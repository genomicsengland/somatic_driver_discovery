process INGEST_PARAM {
    ...
    */
    ...
    [[ -n "${signature_normalize_by_sites}" ]] && cmd+=" --signature_normalize_by_sites ${signature_normalize_by_sites}"
    [[ "${mutability_adjusting}" == "true" ]] && cmd+=" --mutability_adjusting"
    ...
    [[ "${depth_adjusting}" == "true" ]] && cmd+=" --depth_adjusting"
    ...
    [[ "${statistic_discard_mnp}" == "true" ]] && cmd+=" --statistic_discard_mnp"
    ...
    [[ "${indels_include}" == "true" ]] && cmd+=" --indels_include"
    ...
    [[ "${indels_gene_exomic_frameshift_ratio}" == "true" ]] && cmd+=" --indels_gene_exomic_frameshift_ratio"
